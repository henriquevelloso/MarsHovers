...
@objc protocol ShowPhotoRoutingLogic
{
...
class ShowPhotoRouter: NSObject, ShowPhotoRoutingLogic, ShowPhotoDataPassing
{
  ...
  //func navigateToSomewhere(source: ShowPhotoViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: ShowPhotoDataStore, destination: inout SomewhereDataStore)
  //{
